  ...
  $(document).on('turbo:ready', function() {
    return $(function() {
      return $('a[data-remote]').on('ajax:success', function(e, data, status, xhr) {
        return $(this).next('div').prepend(data);
      });
    });
  });
...
(function() {
  $(document).on('ready page:load', function() {
    ...
    set_active_nav = function() {
      var current_url, nav_link, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (nav_link.href === current_url) {
          ...
          _results.push($(nav_link).addClass('active'));
        } else {
...
(function() {
  $(document).on('turbo:ready', function() {
    return $('tr.table-link').on('click', function() {
...
(function() {
  $(document).on('turbo:ready', function() {
    return $('.instant-tooltip').tooltip({
      animation: true,
      trigger: 'focus',
      placement: 'right',
      html: true
